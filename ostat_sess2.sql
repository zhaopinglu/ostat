...
prompt Usage: @ostat_sess2 interval_seconds sid_number
...
select name,value,s.con_id from v$sesstat s,v$statname n
where s.statistic#=n.statistic# and s.con_id=n.con_id
and sid=&2
)
